				...
				<div class="mb-3">
					...
					<c:forEach var="indicator" items='${indicators}'>
						<div class="form-check">
							<input class="form-check-input" type="checkbox" value="${indicator.id}" name="actionList" id="action_wording_${indicator.id}">
							<label class="form-check-label" for="action_wording_${indicator.id}">
									${indicator.wording}
							</label>
						</div>
					</c:forEach>
